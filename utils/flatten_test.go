...
// this code has been copied from https://github.com/chidiwilliams/flatbson
// and modified to work with a mongodb v2 driver
...
func (c customBSONTypeLeaf) MarshalBSONValue() (byte, []byte, error) {
	typ, v, err := bson.MarshalValue(c.S)
