...
// this code has been copied from https://github.com/mongodb/mongo-go-driver/blob/master/bson/struct_tag_parser.go
// this was needed because the struct tag parser is not exported anymore, so we have to copy it
